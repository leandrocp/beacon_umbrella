...
if config_env() == :prod do
  ...
  #
  #     config :cms_admin_web, CmsAdminWeb.Mailer,
  ...
  # to start each relevant endpoint:
  #
  #     config :big_app_web, BigAppWeb.Endpoint, server: true
  #
  # Then you can assemble a release by calling `mix release`.
  # See `mix help release` for more information.
  ...
  config :big_app, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
end
